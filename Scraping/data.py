...
if __name__ == '__main__':
    db = Database()
    #db.kill_table("FILESS")
    db.create_tabeles()
    #db.runcmd("INSERT INTO FILES (ibge, procurement_id, file_id, OCR_RAW, name, date) Select ibge, procurement_id, file_id, OCR_RAW, name, date from FILESS")
    #db.runcmd("UPDATE FILES set path = REPLACE(path, 'Data', 'Files')")
